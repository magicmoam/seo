...
export function render(r) {
  ...
  h += `<div class="panel"><div class="panel-label">Dominant Intent: ${esc(r.dominant_intent)}</div><p style="font-size:14px;font-weight:300;line-height:1.7;color:var(--c-text-secondary)">${esc(r.summary)}</p></div>`;
  return h;
}
