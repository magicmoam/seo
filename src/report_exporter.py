...
<title>Retune Report - {_esc(tool_label)}</title>
<style>{_CSS}</style>
</head>
<body>
<div class="meta">Retune SEO Intelligence | {_esc(tool_label)} | Generated {ts}</div>
{body}
<div class="footer">Generated by <strong>Retune</strong> - AI-Powered SEO Intelligence | {ts}</div>
</body>
</html>"""
